...
var transitionCollapse = false, transitionExpand = false, setMedia = null, allHoverElements = [], tHandler, eventType = null, isActive = null, tabbableBreadcrumb = [], focusable = null;
...
var getGrouped = function (target, toggleActiveClass, group, role, splitselectorToggle, splitselectorGroup, eventType, next, selectorAnimate) {
    return [].slice
        ...
        return __spreadArray(__spreadArray([], __read(obj)), [toggle, drop]);
    }, []);
};
/**
 * Get Toggles
...
var Toggle = function (userSettings) {
    ...
    var toggleItems = function (event) {
        ...
        var selector = target.getAttribute(splitselectorToggle), group = target.getAttribute(splitselectorGroup), role = target.getAttribute(splitselectorRole), next = target.closest(selectorNext), allGrouped = group
            ...
            : [], allToggles = getToggles(target, toggleActiveClass, selector, role, next, splitselectorToggle, eventType, splitselectorBack), allDrops = getDrops(target, toggleActiveClass, selector, role, next, splitselectorToggle, eventType, splitselectorAnimate), allElements = __spreadArray(__spreadArray(__spreadArray([], __read(allGrouped)), __read(allToggles)), __read(allDrops));
